...
public class Game
    ...
    public void create() {
        ...
        ((PluginInjection) components.getBean("pluginInjector")).loadPlugins(gameData, world);
    }
    ...
    private void update() {
        ...
        ((IProcessor) components.getBean("processInjection")).process(gameData, world);
        ((IProcessor) components.getBean("postProcessInjection")).process(gameData, world);
    }
